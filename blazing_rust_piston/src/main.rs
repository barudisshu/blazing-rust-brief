...
fn start_app() {
    ...
    let font_path = match OpenOptions::new().read(true).open("FiraMono-Bold.ttf") {
        ...
        Err(_) => {
            match OpenOptions::new().read(true).open("assets/fonts/FiraMono-Bold.ttf") {
                Ok(_) => Path::new("assets/fonts/FiraMono-Bold.ttf"),
    ...
    let mut app = App {
        ...
        tetris: Tetris::new(),
        elapsed_time: 0.0,
        cache: GlyphCache::new(font_path, (), TextureSettings::new()).unwrap(),
    };
